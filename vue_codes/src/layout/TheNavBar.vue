<template>
    <nav class="navbar sidebar-sticky navbar-expand navbar-light bg-white">
      ...
      <form v-if="$route.meta.page=='admin'" method="GET" class="form-inline d-none d-sm-inline-block" ENCTYPE="multipart/form-data">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
              <i class="align-middle" data-feather="user"></i> <span class="text-dark">{{ cookies.get('_name') }}</span>
            </a>
...
<!-- <selectSite v-if="
        ...
        $route.path == '/dataglunt'          ||           
        $route.path == '/recentdata'         ||
        $route.path == '/trendanalysis'      ||       
        $route.path == '/advancedanalysis'   ||  
        $route.path == '/promotionanalysis'  ||  
        $route.path == '/brandoverview'      ||  
        $route.path == '/weatheranalysis'    ||  
        $route.path == '/kpi'                ||  
        $route.path == '/comparebytime'      ||  
        $route.path == '/comparebyplace'     ||  
        $route.path == '/trafficdistribution'||
        $route.path == '/comparebylabel'     ||  
        $route.path == '/heatmap'            ||  
        $route.path == '/agegender'          ||  
        $route.path == '/macsniff'           ||  
        $route.path == '/reportsummary'      ||  
        $route.path == '/reportstandard'     ||  
        $route.path == '/reportpremium'      ||  
        $route.path == '/reportexport'       ||  
        $route.path == '/sensors'            || 
        $route.path == '/sitemap'            ||  
        $route.path == '/about'              ||
        $route.path == '/feedback'"
